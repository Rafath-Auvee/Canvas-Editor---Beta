const TextStyleEditor = ({ textStyle, handleTextStyleChange }) => {
    ...
    return (
      <div className="flex justify-center mt-4">
        <div className={`flex flex-col items-center mx-4 border-blue-500 border-2`}>
          ...
          <div className="flex mt-2">
            <button onClick={() => handleIncrement("left")} className="bg-gray-200 rounded px-2 py-1 mr-1">+</button>
            <button onClick={() => handleDecrement("left")} className="bg-gray-200 rounded px-2 py-1">-</button>
          </div>
          ...
          />
          <div className="flex mt-2">
            <button onClick={() => handleIncrement("top")} className="bg-gray-200 rounded px-2 py-1 mr-1">+</button>
            <button onClick={() => handleDecrement("top")} className="bg-gray-200 rounded px-2 py-1">-</button>
          </div>
          ...
          />
          <div className="flex mt-2">
            <button onClick={() => handleIncrement("fontSize")} className="bg-gray-200 rounded px-2 py-1 mr-1">+</button>
            <button onClick={() => handleDecrement("fontSize")} className="bg-gray-200 rounded px-2 py-1">-</button>
          </div>
        </div>
      </div>
    );
